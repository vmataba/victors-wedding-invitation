...
async function handler(event) {
  const guestId = event.path.replace('/.netlify/builders/og-meta/', '');
...
<html lang="en">
  <head>
    ...
    <script>
      ...
      if (!/bot|crawler|spider|crawling/i.test(navigator.userAgent)) {
        window.location.href = "/?path=/${guestId}";
      }
    </script>
  ...
  <body>
    ...
    <noscript>
      <p>Loading your personalized invitation...</p>
      <p><a href="/?path=/${guestId}">Click here if not redirected automatically</a></p>
    </noscript>
  </body>
</html>`;
